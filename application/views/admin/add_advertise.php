<div class="page-head">
                    <h1>Add advertisement  <small></small></h1>
                    <ol class="breadcrumb">
						<li>You are here:</li>
                        <li><a href="dashboard.php?p=home">Dashboard</a></li>
                        <li class="dashboard.php?p=all-user">Add advertisement</li>
                    </ol>
</div>
                   ...
                   <div class="box-body">
							<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<button type="submit" class="btn btn-primary">Register</button></label>
