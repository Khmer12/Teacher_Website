...
<html>
	<head>
        ...
        <link rel="stylesheet" href="<?php echo base_url()?>admin/css/bootstrapValidator/bootstrapValidator.min.css" />
	...
	<body class="login fixed">
		<div class="wrapper animated flipInY">
			...
			<div class="box">
				...
				<form id="loginform" method="post" action="admin/home">
			...
			<div class="box-extra clearfix">
				...
				<a href="register.php" class="pull-right btn  btn-xs">Register an account</a>
			</div>
		...
		<!-- Forms -->
        <script src="<?php echo base_url()?>admin/js/plugins/bootstrapValidator/bootstrapValidator.min.js" type="text/javascript"></script>
